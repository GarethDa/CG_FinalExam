...
#pragma endregion 
		...
		*/
		...
		GameObject::Sptr knight1 = scene->CreateGameObject("Knight 1");
		{
			// Set position in the scene
			knight1->SetScale(glm::vec3(2.5f, 2.5f, 2.5f));
			knight1->SetPostion(glm::vec3(1.5f, 0.0f, 0.0f));
			knight1->SetRotation(glm::vec3(90.0f, 0.0f, 175.0f));

			// Create and attach a renderer for the monkey
			RenderComponent::Sptr renderer = knight1->Add<RenderComponent>();
			...
			knight1->Add<LerpBehaviour>()->SetParams(points, 2.0f);

			knight1->Add<EnemyBehaviour>()->SetProj(projectile);

			GameObject::Sptr particles = scene->CreateGameObject("Particles");
			knight1->AddChild(particles);
			particles->SetPostion({ 0.0f, 0.0f, 0.0f });
		...
		GameObject::Sptr knight2 = scene->CreateGameObject("Knight 2");
		{
			// Set position in the scene
			knight2->SetScale(glm::vec3(2.5f, 2.5f, 2.5f));
			knight2->SetPostion(glm::vec3(10.0f, 11.0f, 0.0f));
			knight2->SetRotation(glm::vec3(90.0f, 0.0f, 50.0f));

			// Create and attach a renderer for the monkey
			RenderComponent::Sptr renderer = knight2->Add<RenderComponent>();
			renderer->SetMesh(KnightMesh);
			renderer->SetMaterial(KnightMaterial);
			...
			knight2->Add<LerpBehaviour>()->SetParams(points, 1.5f, true, false);

			knight2->Add<EnemyBehaviour>()->SetProj(projectile2);

			GameObject::Sptr particles = scene->CreateGameObject("Particles");
			knight2->AddChild(particles);
			particles->SetPostion({ 0.0f, 0.0f, 0.0f });
